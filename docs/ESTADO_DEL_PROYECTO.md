...
### [~] P4 related reviews / comparadores — en progreso
...
- Pendiente frontend: leer relaciones ya cerradas y mostrarlas como reviews relacionadas; preparar ruta `/comparar/a-vs-b`.

### [ ] P5 rankings automáticos — pendiente
