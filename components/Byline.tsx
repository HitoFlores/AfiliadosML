...
export function SourcesBlock({
  ...
  return (
    <section className="my-12 bg-gray-50 border border-gray-200 rounded-2xl p-6">
      <h2 className="text-lg font-bold text-gray-900 mb-2">Metodología de análisis</h2>
      ...
      <p className="text-xs text-gray-400 mt-5 pt-4 border-t border-gray-200">
        Algunos enlaces son de afiliado: si comprás a través de ellos, apoyás este sitio sin costo extra para vos.
      </p>
    </section>
  );
}
